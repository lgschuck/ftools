...
#'
#' @examples
#' f_num(12345678956, billion = 'G') #returns "12 G"
#' f_num(512347896, million = 'Mi') #returns "512 Mi"
#' f_num(9995198, thousand = 'm', digits = 3, dec = ',', big = '.') #returns "9,995 M"
#' f_num(55566312345678956, billion = 'G') #returns "55,566,312 G"
#' f_num(Inf) #returns "Inf"
#' f_num(-Inf) #returns "-Inf"
#'
#' @export
